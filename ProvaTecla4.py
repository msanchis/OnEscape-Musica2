...
tecla2_1 = pygame.mixer.Sound('/home/pi/audio2/C1-1.ogg')
tecla2_2 = pygame.mixer.Sound('/home/pi/audio2/C1-2.ogg')
tecla2_3 = pygame.mixer.Sound('/home/pi/audio2/C1-3.ogg')
...
def on_connect(client,userdata,flags,rc):
    ...
    client.subscribe("sala2/tecla4",1)
...
client = mqtt.Client("ProvaTecla4") #creant una estancia
