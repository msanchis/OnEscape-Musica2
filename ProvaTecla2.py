...
tecla2_1 = pygame.mixer.Sound('/home/pi/audio2/A#1-1.ogg')
tecla2_2 = pygame.mixer.Sound('/home/pi/audio2/A#1-2.ogg')
tecla2_3 = pygame.mixer.Sound('/home/pi/audio2/A#1-3.ogg')
...
def on_connect(client,userdata,flags,rc):
    ...
    client.subscribe("sala2/tecla2",1)
    print("Suscrito a los temas dificultad y tecla2")
...
client = mqtt.Client("ProvaTecla2") #creant una estancia
